 ...
 * @author silva
 */
public class AddSalePopup extends javax.swing.JFrame {
    private TransactionsPanel parent;
    private StockDao stock;
    /**
     * Creates new form AddSalePopup
     */
    public AddSalePopup() {
        initComponents();
        loadStock();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSalePopup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSalePopup().setVisible(true);
            }
        });
    }
